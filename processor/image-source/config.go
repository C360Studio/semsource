// Package imagesource provides the image-source processor component for semsource.
// It ingests image file directories and publishes image entity payloads to the
// NATS graph ingestion stream.
package imagesource
...
// Config holds configuration for the image-source processor component.
type Config struct {
	Ports *component.PortConfig `json:"ports" schema:"type:ports,description:Port configuration,category:basic"`

	// Paths is the list of filesystem directories to walk for image files.
	// At least one path is required.
	Paths []string `json:"paths" schema:"type:array,description:Filesystem directories to scan for images (.png .jpg .jpeg .gif .webp .svg),category:basic,required:true"`
...
// DefaultConfig returns the default configuration for the image-source processor.
