...
| `websocket_path`          | `"/ws"`              | Raw GRAPH stream WebSocket path. Configurable again since semstreams beta.161 restored the path surface (#147, semstreams#945); `/ws` remains the documented contract path                          |
