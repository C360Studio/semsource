...
## Purpose
Make the shipped Docker Compose stack a trustworthy install: durable across
container recreation, honestly health-checked, reproducible (pinned images,
identifiable builds), and bootable through every configuration path the
