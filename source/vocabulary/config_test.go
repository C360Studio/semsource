...
func TestConfigPredicateConstantValues(t *testing.T) {
	...
	checks := []struct {
		...
		{"ConfigFilePath", ConfigFilePath, "source.config.file-path"},
		{"ConfigModulePath", ConfigModulePath, "source.config.module-path"},
		{"ConfigModuleGoVer", ConfigModuleGoVer, "source.config.module-go-version"},
		...
		{"ConfigProjectGroup", ConfigProjectGroup, "source.config.project-group-id"},
		{"ConfigProjectArtifact", ConfigProjectArtifact, "source.config.project-artifact-id"},
		...
		{"ConfigImagePorts", ConfigImagePorts, "source.config.image-exposed-ports"},
