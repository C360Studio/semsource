...
const (
	...
	MediaMimeType = "source.media.mime-type"
	...
	MediaStorageRef = "source.media.storage-ref"
...
const (
	...
	// Phase 2: video ingestion only.
	MediaFrameRate = "source.media.frame-rate"
	...
	// Phase 2: video ingestion only.
	MediaKeyframeCount = "source.media.keyframe-count"
)
...
const (
	...
	MediaBitDepth = "source.media.bit-depth"
)
