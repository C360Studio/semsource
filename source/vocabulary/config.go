...
const (
	...
	ConfigFilePath = "source.config.file-path"
)
...
const (
	...
	// Example: "1.22"
	ConfigModuleGoVer = "source.config.module-go-version"
)
...
const (
	...
	ConfigProjectGroup = "source.config.project-group-id"

	// ConfigProjectArtifact is the Maven artifactId or Gradle project name.
	// Example: "my-service", "spring-boot"
	ConfigProjectArtifact = "source.config.project-artifact-id"
...
const (
	...
	ConfigImagePorts = "source.config.image-exposed-ports"
)
